...
citiesfile = open("post no/citiesIndex.ujson", "r+")
baseFile = open("post no/baseDict.ujson", "r+")
fileFile = open("post no/fileIndex.ujson", "r+")
...
searcher = Searcher("/stop_words.txt", "post no", False,ReadBaseDict,ReadFileIndex,
                    False, False)
